...
local Window = Rayfield:CreateWindow({
    ...
    Icon = 85108798400826,
    LoadingTitle = "REAPERHUB",
    LoadingSubtitle = "made by anti_cheat95",
    Theme = "DarkBlue",
    ...
    KeySettings = {
       Title = "KEY SYSTEM",
       Subtitle = "Key System",
       Note = "JOIN OUR DISCORD .gg/RvPy7FtqbF",
       FileName = "ASUBABFTKey",
       SaveKey = false,
       GrabKeyFromSite = false,
       Key = {"1htoddbs298437588fdhvuujdfhtthhgg_key"} -- yes there is a keysystem but my script is not obfuscated lol
    }
})
...
local Button = Credit:CreateButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/RvPy7FtqbF")
        Rayfield:Notify({
            Title = "Copied!",
...
Section = Credit:CreateSection("made by anti_cheat95")

local Labeld = Credit:CreateLabel("Owner: @anti_cheat95", 93981953300699, Color3.fromRGB(255, 255, 255), true)
...
BY ANTI_CHEAT95
@anti_cheat95 | Build A Boat For Treasure

discord server: https://discord.gg/RvPy7FtqbF
]]
Init()
