...
local Window = Rayfield:CreateWindow({
    ...
    LoadingSubtitle = "Made With ❤️ by @thedarkV2",
    Theme = "DarkBlue",
    ...
    KeySettings = {
       Title = "BLUEX KEY",
       Subtitle = "Key System",
       Note = "GET KEY FORM WEBSITE https://loot-link.com/s?vKdCCaGd",
...
local Paragraph = Global:CreateParagraph({Title = "Script is codet by me", Content = "i am sorry but i will update it"})
...
Section = Global:CreateSection("Auto Farm - codet by @thedarkv2")
